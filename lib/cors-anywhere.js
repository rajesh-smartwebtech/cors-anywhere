...
var onProxyResponseUpdate = function(res, proxyRes, body){
  return body;
};
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  modifyResponse(res, proxyRes.headers['content-encoding'], function (body) {
      return onProxyResponseUpdate(res, proxyRes,body);
  });
...
exports.createServer = function createServer(options) {
  ...
  onProxyResponseUpdate = function(res, proxyRes, body){
    return body;
  };
  if( options.onProxyResponseUpdate != undefined ){
    let vv = options.onProxyResponseUpdate;
    delete options.onProxyResponseUpdate;
    onProxyResponseUpdate = vv;
  }
